...
def plot(all_windows, all_preds, all_trues, num_samples, forecast_horizon, results=None, predictions=None):
    import numpy as np
    ...
    for i in range(num_samples):
        j = i + 3  # or use np.random.randint(0, len(all_trues)) for randomness
