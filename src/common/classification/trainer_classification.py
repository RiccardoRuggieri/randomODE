        ...
        for batch in train_dataloader:
            ...
            with _SuppressAssertions(tqdm_range):
                *train_coeffs, train_y, lengths = batch
                # predictions here, look at the times - they are needed!
...
def make_model(name, input_channels, output_channels, hidden_channels, hidden_hidden_channels, num_hidden_layers,
    ...
    """
    Each model is composed of a vector field and a NeuralSDE model. This function returns a function that creates
    the model and vector field.
    :param name:
    :param input_channels:
    :param output_channels:
    :param hidden_channels:
    :param hidden_hidden_channels:
